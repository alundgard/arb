...
var ft1699591 = {
	confID:window.ftConfID_1699591||"0",
	GUID:window.ftGUID_1699591||"99999999999",
	ftId:'',
    ftImpId: window.ftImp1699591 && window.ftImp1699591.impID || '',
	params:window.ftParams_1699591||"",
	segment:window.ftSegment_1699591||"",
	segmentList:window.ftSegmentList_1699591||[],
	keyword:window.ftKeyword_1699591||"",
	ftReturn: window.ftReturn_1699591||"",
	exttrack:["https://dishdigital.sp1.convertro.com/view/vt/v1/dishdigital/15/cvo.gif?cvosrc=Display.Dstillery.MOVERS&cvo_cid=58116&cvo_creative=USP_TiedUp_300x250.zip&cvo_pid=SLNGD_USA_MOVERS_DT_DIS_XXX_MBD_DSTMOVERCA_ADULTPR_XXXXXX_300x250","https://pixel.moatads.com/pixel.gif?e=12&ac=1&bq=0&dz=1&f=0&gh=1&i=KEPLER_SLINGTV_FLASHTALKING1&t=[%FT_RANDOM%]&de=[%FT_RANDOM%]&d=7737%3A58116%3A1699591%3A1364267&bd=8626&cs=0"],
	extscript:["https://z.moatads.com/keplerslingtvflashtalking517548650154/moatad.js#moatClientLevel1=7737&moatClientLevel2=58116&moatClientLevel3=1699591&moatClientLevel4=1364267&moatClientSlicer1=8626[noCachebuster]"],
	pID:"1699591",
	cID:"54359",
	campaignID:"58116",
	siteName:"DstilleryUS",
	placementDescription:"SLNGDUSAMOVERSDTDISXXXMBDDSTMOVERCAADULTPRXXXXXX300x250",
	creativeID:"1364267",
	width:300,
	height:250,
	divID:"ftdiv1699591",
	frameID:"ftframe1699591",
	altImgID:"ftalt1699591",
	altText:"Click here",
	altImgTarget:"_blank",
	altImgHref:"http://servedby.flashtalking.com/click/8/58116;1699591;1364267;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.sling.com/programming?cvosrc=Display.Dstillery.MOVERS&cvo_cid=58116&cvo_creative=USP_TiedUp_300x250.zip&cvo_pid=SLNGD_USA_MOVERS_DT_DIS_XXX_MBD_DSTMOVERCA_ADULTPR_XXXXXX_300x250&utm_source=directbuy&utm_medium=display&utm_campaign=ADULTPR",
    tracking3rdParty: {
        videoQuartiles: JSON.parse('[%thirdparty_video_quartiles%]'.replace(/^(\[%\w+%])?$/, '{}')),
        userEngagement: '[%thirdparty_user_engagement%]'.replace(/^\[%\w+%\]$/, '')
    },
	clickTags: ["http://servedby.flashtalking.com/click/8/58116;1699591;1364267;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.sling.com/programming?cvosrc=Display.Dstillery.MOVERS&cvo_cid=58116&cvo_creative=USP_TiedUp_300x250.zip&cvo_pid=SLNGD_USA_MOVERS_DT_DIS_XXX_MBD_DSTMOVERCA_ADULTPR_XXXXXX_300x250&utm_source=directbuy&utm_medium=display&utm_campaign=ADULTPR"],
	altImg:"http://servedby.flashtalking.com/imp/8/58116;1699591;204;gif;DstilleryUS;SLNGDUSAMOVERSDTDISXXXMBDDSTMOVERCAADULTPRXXXXXX300x250/?",
	viewableImpressionURL: "http://servedby.flashtalking.com/imp/8/58116;1699591;202;pixel;DstilleryUS;SLNGDUSAMOVERSDTDISXXXMBDDSTMOVERCAADULTPRXXXXXX300x250/?",
    stump: "http://servedby.flashtalking.com",
	file:"http://cdn.flashtalking.com/54359/1364267/index.html",
	...
	statBaseURL:"http://stat8.flashtalking.com/reportV3/ft.stat?66163950-1699591;1364267;",
	centreAd:false,
    iDeviceImp:"http://servedby.flashtalking.com/imp/8/58116;1699591;207;guid;DstilleryUS;SLNGDUSAMOVERSDTDISXXXMBDDSTMOVERCAADULTPRXXXXXX300x250/?ft_guid=[%"+"FT_GUID%]&cachebuster=[%"+"CACHEBUSTER%]",
	adWindow:null,
	mvt:false,
	blockBrowsers:"".split(","),
	eventListeners:{},
	...
	secure: location.protocol === 'https:'||!!(document.querySelector&&document.querySelector('#ftscript_m1699591[src^="https:"]')) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc','')),
	storeGUID:/iP(ad|hone|od)/.test(navigator.appVersion),
	scriptLocation: document.getElementById('ftscript_m1699591'),
	customPos: false,
	...
	outputDiv:function(fullAd){
		...
		if(badWrite || (window.ftImp1699591 && window.ftImp1699591.jsAppend)) {
...
//--start extensions
    ...
    o.addEventListener('start', function(){
        for (var i = 0; i < o.clickTags.length; i++) {
            var thisCT=o.clicks["clickTag" + (i+1)];
            thisCT=decodeURIComponent(thisCT);
            o.clicks["clickTag" + (i+1)] = thisCT;
        }
      }); 
}(ft1699591));
