...
//    
    ...
    //Set positions and attributes
        TweenLite.set(txt1, {opacity:1, top:18, left:13});
        TweenLite.set(txt2, {opacity:0, left: 740, top:48});
...
function animation1(){
    ...
    TweenLite.to(txt2, 0.5, {delay:1.6, opacity:1, left:16, ease: Back.easeOut.config(1)});
